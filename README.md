...
## [>> Пример запуска проекта в Google Colab](https://colab.research.google.com/drive/13ELTM5zncaotpm2V865wV-uZPEAjcG0Q?usp=sharing)
...
| --no-plots   |                     | action='store_true' |                                               | Не сохранять графики на диск.                                                                                                                                                                 |
| --only-plots |                     | action='store_true' |                                               |                                                                                                                                                                                               |
